...
public class UserService {
    ...
    public Boolean userAttentioninsert(int[] asd){return userDao.userAttentioninsert(asd);}
    public Boolean userAttendiondelete(int[] asd){return userDao.userAttentiondelete(asd);}
